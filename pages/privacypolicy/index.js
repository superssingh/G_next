...
const Policy = () => {
  return (
    <div className="grid relative w-full place-items-center place-content-center text-sm ">
      <div className="w-full sm:w-64 md:w-full max-w-3xl bg-white/[0.35] shadow-lg drop-shadow-md border-y-2 border-slate-100/[.45] rounded-lg px-4 mb-6  ">
        ...
        <div className="terms rounded-lg">
          ...
          <p>
            ...
            recorded by gogixer.com and how we use it.
          </p>
          ...
          <p>
            ...
            <a href="generateprivacypolicy.com/#cookies">
          ...
          <p>
            ...
            advertising partners of gogixer.com.
          </p>
          ...
          <p>
            Note that gogixer.com has no access to or control over these cookies
          ...
          <p>
            gogixer.com does not knowingly collect any Personal Identifiable
