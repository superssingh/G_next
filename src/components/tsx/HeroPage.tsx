              ...
              <div className="grid max-w-5xl justify-center">
                ...
                <div className="grid place-content-center md:place-content-start py-2">
                  <Link
                    ...
                    legacyBehavior
                  >
                    <div className="w-fit font-bold p-4 text-lg fancyRadius1 text-center randomBG shadow-md shadow-black rounded-full group hover:-hue-rotate-15">
                      <div className=" font-bold p-4 text-lg fancyRadius1 text-center randomBG1 shadow-lg shadow-black rounded-full animate-pulse hover:animate-none group-hover:bg-black/30 ">
                        <span>{`Let's Go`}</span>
                      </div>
                    </div>
                  </Link>
