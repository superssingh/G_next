...
const Services = () => {
  return (
    <div className="bg-white/20 py-4 grid items-center md:justify-center  relative transition-all duration-500 showFromTop ">
      <div className="relative text-center  md:justify-center items-center text-slate-100 my-8">
        ...
        <div className="grid w-full relative md:grid-cols-3 gap-0 md:gap-0 mt-4">
