...
const Steps = () => {
  return (
    <div className="bg-white/80 p-4 my-4">
      ...
      >
        <div class="mx-auto grid max-w-2xl grid-cols-1 lg:gap-y-16 gap-x-14 lg:max-w-5xl lg:px-8 xl:max-w-none xl:grid-cols-12 xl:px-0">
          ...
          <div class="-mb-4 space-y-12 lg:col-span-8 xl:col-span-7 xl:col-start-6 text-center">
            <section>
              ...
              {TagName.steps.map((s, i) => {
                return (
                  <dlv class="mt-2 divide-y divide-slate-100 key={i} ">
