...
const Categories = ({ categories }) => {
  return (
    <div className="w-full bg-white bg-opacity-50 shadow-xl drop-shadow-md rounded-lg p-6 mb-6">
      <h3 className=" text-md text-gray-800 border-b pb-2">Categories</h3>
      {categories.map((m) => (
