...
const PostWidget = ({ recentPosts, category, id }) => {
  ...
  return (
    <div className="relative w-full md:w-80 m-2 place-self-start bg-white bg-opacity-50 shadow-lg drop-shadow-md border-y-2 border-slate-100/[.45] rounded-lg p-6 mb-6 md:mx-2">
